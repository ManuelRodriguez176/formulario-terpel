...
/* ── Inicializa la fecha visible en el header ── */
function initFecha() {
...
/* ── Genera el HTML de una card de equipo ── */
  ...
  <div class="equipo-card" id="equipo-${n}">
    ...
    <div class="equipo-body">
      ...
      <div class="foto-wrap" id="fotoSerialWrap-${n}">
        ...
        <div class="foto-drop" id="dropSerial-${n}">
...
/* ── Genera N cards de equipos en el contenedor ── */
...
/* ── Activa/desactiva el campo serial según el checkbox ── */
...
/* ── Muestra la previsualización de la foto seleccionada ── */
...
/* ── Envía el formulario al Apps Script ── */
async function enviarFormulario() {
  ...
  try {
    ...
    for (let i = 1; i <= cantidad; i++) {
      ...
      // Inputs de foto: el primero es serial, el segundo es placa
